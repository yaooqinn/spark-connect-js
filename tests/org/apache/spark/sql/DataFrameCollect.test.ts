...
test("long", async () => {
  const spark = await sharedSpark;
  const df = await spark.sql("SELECT 1L as a, 9223372036854775807L `b.c`").then(df => {
...
test("float", async () => {
  const spark = await sharedSpark;
  const df = await spark.sql("SELECT 1.0f as a, 1.0e-8f `b.c`").then(df => {
      return df.collect().then(rows => {
...
test("double", async () => {
  const spark = await sharedSpark;
  const df = await spark.sql("SELECT 1.0d as a, 1.0e-8d `b.c`").then(df => {
      return df.collect().then(rows => {
...
test("decimal", async () => {
  ...
  const spark = await sharedSpark;
  const df = await spark.sql("SELECT 1.0bd as a, 1.0e-8bd `b.c`" + `, ${max}.123456 as d`).then(df => {
      return df.collect().then(rows => {
...
test("string", async () => {
  const spark = await sharedSpark;
  const df = await spark.sql("SELECT 'a' as a, 'b' `b.c`").then(df => {
      return df.collect().then(rows => {
...
test("binary", async () => {
  ...
  const df = await spark.sql("SELECT cast('apache' as binary) as a, cast('spark' as binary) `b.c`").then(df => {
      return df.collect().then(rows => {
...
test("date", async () => {
  const spark = await sharedSpark;
  const df = await spark.sql("SELECT date'2021-01-01' a, date'2018-11-17' `b.c`").then(df => {
      return df.collect().then(rows => {
...
test("timestamp_ntz", async () => {
  const spark = await sharedSpark;
  return await spark.sql("SELECT timestamp_ntz'2021-01-01 01:00:00' a, timestamp_ntz'2018-11-17 13:33:33' `b.c`").then(df => {
      return df.collect().then(rows => {
...
test("boolean array", async () => {
  ...
  const spark = await sharedSpark;
  return await spark.sql("SELECT array(true, false, true) a, array(false, true, false) `b.c`, array(array(true, false, true), array(false, true, false)) d").then(df => {
      return df.collect().then(rows => {
...
test("byte array", async () => {
  ...
  const spark = await sharedSpark;
  return await spark.sql("SELECT array(1Y, 2Y, 3Y) a, array(4Y, 5Y, 6Y) `b.c`, array(array(1Y, 2Y, 3Y), array(4Y, 5Y, 6Y)) d").then(df => {
      return df.collect().then(rows => {
...
test("short array", async () => {
  ...
  const spark = await sharedSpark;
  return await spark.sql("SELECT array(1S, 2S, 3S) a, array(4S, 5S, 6S) `b.c`, array(array(1S, 2S, 3S), array(4S, 5S, 6S)) d").then(df => {
      return df.collect().then(rows => {
...
test("integer array", async () => {
  ...
  const spark = await sharedSpark;
  return await spark.sql("SELECT array(1, 2, 3) a, array(4, 5, 6) `b.c`, array(array(1, 2, 3), array(4, 5, 6)) d").then(df => {
      return df.collect().then(rows => {
...
test("long array", async () => {
  ...
  const spark = await sharedSpark;
  return await spark.sql("SELECT array(1L, 2L, 3L) a, array(4L, 5L, 6L) `b.c`, array(array(1L, 2L, 3L), array(4L, 5L, 6L)) d").then(df => {
      return df.collect().then(rows => {
...
test("float array", async () => {
  ...
  const spark = await sharedSpark;
  return await spark.sql("SELECT array(1.0f, 2.0f, 3.0f) a, array(4.0f, 5.0f, 6.0f) `b.c`, array(array(1.0f, 2.0f, 3.0f), array(4.0f, 5.0f, 6.0f)) d").then(df => {
      return df.collect().then(rows => {
...
test("double array", async () => {
  ...
  const spark = await sharedSpark;
  return await spark.sql("SELECT array(1.0d, 2.0d, 3.0d) a, array(4.0d, 5.0d, 6.0d) `b.c`, array(array(1.0d, 2.0d, 3.0d), array(4.0d, 5.0d, 6.0d)) d").then(df => {
      return df.collect().then(rows => {
...
test("decimal array", async () => {
  ...
  const spark = await sharedSpark;
  return await spark.sql("SELECT array(1.0bd, 2.0bd, 3.0bd) a, array(4.0bd, 5.0bd, 6.0bd) `b.c`, array(array(1.0bd, 2.0bd, 3.0bd), array(4.0bd, 5.0bd, 6.0bd)) d").then(df => {
      return df.collect().then(rows => {
...
test("string array", async () => {
  ...
  const spark = await sharedSpark;
  return await spark.sql("SELECT array('a', 'b', 'c') a, array('d', 'e', 'f') `b.c`, array(array('a', 'b', 'c'), array('d', 'e', 'f')) d").then(df => {
      return df.collect().then(rows => {
...
test("binary array", async () => {
  ...
  const spark = await sharedSpark;
  return await spark.sql("SELECT array(cast('apache' as binary), cast('spark' as binary)) a, array(cast('spark' as binary), cast('apache' as binary)) `b.c`, array(array(cast('apache' as binary), cast('spark' as binary)), array(cast('spark' as binary), cast('apache' as binary))) d").then(df => {
      return df.collect().then(rows => {
...
test("date array", async () => {
  ...
  const spark = await sharedSpark;
  return await spark.sql("SELECT array(date'2021-01-01', date'2018-11-17', date'2020-12-31') a, array(date'2020-12-31', date'2018-11-17', date'2021-01-01') `b.c`, array(array(date'2021-01-01', date'2018-11-17', date'2020-12-31'), array(date'2020-12-31', date'2018-11-17', date'2021-01-01')) d").then(df => {
      return df.collect().then(rows => {
...
test("map array", async () => {
  ...
  const spark = await sharedSpark;
  return await spark.sql("SELECT array(map('a', 1, 'b', 2, 'c', 3), map('d', 4, 'e', 5, 'f', 6)) a, array(map('d', 4, 'e', 5, 'f', 6), map('a', 1, 'b', 2, 'c', 3)) `b.c`, array(array(map('a', 1, 'b', 2, 'c', 3), map('d', 4, 'e', 5, 'f', 6)), array(map('d', 4, 'e', 5, 'f', 6), map('a', 1, 'b', 2, 'c', 3))) d").then(df => {
      return df.collect().then(rows => {
...
test("null array", async () => {
  const spark = await sharedSpark;
  return await spark.sql("SELECT array(null, null) a, array(null, null) `b.c`, array(array(null, null), array(null, null)) d").then(df => {
      return df.collect().then(rows => {
...
test("empty array", async () => {
  const spark = await sharedSpark;
  return await spark.sql("SELECT array() a,  array(array(), array()) b").then(df => {
      return df.collect().then(rows => {
...
test("array with nulls", async () => {
  const spark = await sharedSpark;
  return await spark.sql("SELECT array(1, null, 3) a, array(null, 5, null) b").then(df => {
      return df.collect().then(rows => {
...
test("boolean/boolean map", async () => {
  ...
  return await spark.sql("SELECT map(TRUE, FALSE) a, map(FALSE, TRUE) b").then(df => {
      return df.collect().then(rows => {
...
test("byte/byte map", async () => {
  ...
  return await spark.sql("SELECT map(1Y, 2Y, 3Y, 4Y) a, map(5Y, 6Y, 7Y, 8Y) b").then(df => {
      return df.collect().then(rows => {
...
test("short/short map", async () => {
  ...
  return await spark.sql("SELECT map(1S, 2S, 3S, 4S) a, map(5S, 6S, 7S, 8S) b").then(df => {
      return df.collect().then(rows => {
...
test("int/int map", async () => {
  ...
  return await spark.sql("SELECT map(1, 2, 3, 4) a, map(5, 6, 7, 8) b").then(df => {
      return df.collect().then(rows => {
...
test("long/long map", async () => {
  ...
  return await spark.sql("SELECT map(1L, 2L, 3L, 4L) a, map(5L, 6L, 7L, 8L) b").then(df => {
      return df.collect().then(rows => {
...
test("float/float map", async () => {
  ...
  return await spark.sql("SELECT map(1.0f, 2.0f, 3.0f, 4.0f) a, map(5.0f, 6.0f, 7.0f, 8.0f) b").then(df => {
      return df.collect().then(rows => {
...
test("double/double map", async () => {
  ...
  return await spark.sql("SELECT map(1.0d, 2.0d, 3.0d, 4.0d) a, map(5.0d, 6.0d, 7.0d, 8.0d) b").then(df => {
      return df.collect().then(rows => {
...
test("decimal/decimal map", async () => {
  ...
  return await spark.sql("SELECT map(1.1bd, 2.1bd, 3.1bd, 4.1bd) a, map(5.1bd, 6.1bd, 7.1bd, 8.1bd) b").then(df => {
      return df.collect().then(rows => {
...
test("string/string map", async () => {
  ...
  return await spark.sql("SELECT map('a', 'b', 'c', 'd') a, map('e', 'f', 'g', 'h') b").then(df => {
      return df.collect().then(rows => {
...
test("binary/binary map", async () => {
  ...
  return await spark.sql("SELECT map(cast('apache' as binary), cast('spark' as binary)) a, map(cast('spark' as binary), cast('apache' as binary)) b").then(df => {
      return df.collect().then(rows => {
...
test("date/date map", async () => {
  ...
  return await spark.sql("SELECT map(date'2021-01-01', date'2018-11-17', date'2020-12-31', date'2021-01-01') a, map(date'2020-12-31', date'2021-01-01', date'2018-11-17', date'2021-01-01') b").then(df => {
      return df.collect().then(rows => {
...
test("array map", async () => {
  ...
  return await spark.sql("SELECT map(array(1, 2), array(3, 4)) a, map(array(5, 6), array(7, 8)) b").then(df => {
      return df.collect().then(rows => {
...
test("map value with nulls", async () => {
  const spark = await sharedSpark;
  return await spark.sql("SELECT map(1, 2, 3, null) a").then(df => {
      return df.collect().then(rows => {
...
test("struct", async () => {
  ...
  return await spark.sql("SELECT named_struct(" +
      "'a', true, " +
      "'b', 1Y, " +
      "'c', 2S, " +
      "'d', 3, " +
